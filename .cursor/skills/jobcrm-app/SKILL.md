...
| PUT | `/companies/{company_id}` | — | `{"name":"","research_status":"","website":"","linkedin":"","industry_ids":[],"hq_locations":[],"employee_count_text":"","actively_hiring":null,"work_mode":"","work_mode_description":"","overview":"","full_product_detail":"","full_hiring_detail":"","full_organization_detail":"","analysis_links":[{"topic":"","link":""}],"enrichment_source_links":[]}` | Partial update — include only keys you change. `research_status` → **research**; `work_mode` → **work**; `analysis_links` is an array of `{topic,link}`. |
