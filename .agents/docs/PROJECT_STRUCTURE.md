...
- `app/dev_seed.py` - reusable local dummy-data seed helpers (focused QA scenarios + broad local-dev dataset)
...
- `scripts/seed_local_dev_dataset.py` - one-command local seed script for broad local-development QA data
